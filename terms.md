...
3. AI Disclaimer
The Service includes AI-generated content and responses.

AI outputs may be inaccurate, incomplete, delayed, or inappropriate.
AI output is provided for informational and companion purposes only.
AI output is not professional advice (medical, legal, financial, or mental health advice).
You are responsible for decisions and actions you take based on AI output.
4. AI Echo Disclaimer and Identity Boundary
AI Echo and AI Persona features are synthetic AI systems.

AI Echo is not a real person.
AI Echo does not impersonate a real person.
AI Echo content must not be interpreted as authentic statements from a real individual.
Any misuse intended to deceive others about AI identity is prohibited.
...
Upload or share unlawful, defamatory, hateful, or violent content
Share sexual exploitation content or non-consensual intimate content
...
Block User
Remove Friend
Reports may be reviewed for policy and safety enforcement. Abuse of reporting systems is prohibited.

8. Content Moderation and Removal
We may review, remove, restrict, or disable User Content or account access when we reasonably believe it:

Violates these Terms
Creates safety risk
Is unlawful or required to be removed by law
Compromises platform integrity or other users
We may preserve records as required for legal, security, and abuse-prevention purposes.

9. Account Suspension and Termination
We may suspend or terminate accounts that violate these Terms, applicable law, or safety requirements.

We may also suspend access to investigate suspected abuse, fraud, or security incidents.

You may stop using the Service at any time and request account deletion per our Privacy Policy.
...
We may modify, suspend, or discontinue features at any time for maintenance, security, legal, or product reasons. We are not liable for feature unavailability to the extent permitted by law.

13. Disclaimers
THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" TO THE MAXIMUM EXTENT PERMITTED BY LAW, WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.

We do not guarantee uninterrupted, error-free, or fully secure operation.

14. Limitation of Liability
TO THE MAXIMUM EXTENT PERMITTED BY LAW, ECHOVA AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AND SERVICE PROVIDERS WILL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, DATA, GOODWILL, OR BUSINESS OPPORTUNITY, ARISING FROM OR RELATED TO THE SERVICE.
